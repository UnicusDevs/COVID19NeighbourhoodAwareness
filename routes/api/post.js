...
// Controller 
const { getAllPosts, getPaginatedPosts, getUserPostsPaginated, getPostBasedOnSuburb, getLatestPost, createNewPost, increaseClap } = require('./../../controllers/post_controller');
...
router.get('/userposts', getUserPostsPaginated);
